...
from nnlandmark.inference.kaggle2025_byu.gaussian_blur_3d import GaussianBlur3D
from nnlandmark.inference.kaggle2025_byu.iterative_maxpool import iterative_3x3_same_padding_pool3d
from nnlandmark.inference.predict_from_raw_data import nnUNetPredictor
from nnlandmark.paths import nnLM_raw
from nnlandmark.training.data_augmentation.kaggle_byu_motor_regression import ConvertSegToRegrTarget
...
from nnlandmark.training.loss.regression import RegDice_and_MSE_loss, RegDice1, RegDice3
...
class MotorRegressionTrainer(nnUNetTrainer):
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        orig_shapes = load_json(join(nnLM_raw, self.plans_manager.dataset_name, 'train_OrigShapes.json'))
        ...
        gt = load_json(join(nnLM_raw, self.plans_manager.dataset_name, 'train_coordinates.json'))
