...
#SBATCH --output=/work/tesi_averonese/nnLandmark/logs/MML06_%j.out
#SBATCH --error=/work/tesi_averonese/nnLandmark/logs/MML06_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python /homes/averonese/nnLandmark/nnlandmark/dataset_conversion/nnLandmark/Dataset737_DMGLD_LFC/06_generate_dataset_json.py

echo "generate_dataset_json finished"