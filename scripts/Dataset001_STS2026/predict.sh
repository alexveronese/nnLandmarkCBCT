...
#SBATCH --output=/work/tesi_averonese/nnLandmark/logs/STS_predict%j.out
#SBATCH --error=/work/tesi_averonese/nnLandmark/logs/STS_predict%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
DATASET_DIR=/work/grana_maxillo/averonese_STS2026/nnLM/nnLM_raw/Dataset001_STS2026/imagesTs
DATASET_ID=001
OUTPUT_DIR=/work/grana_maxillo/averonese_STS2026/nnLM/predictions/Dataset001_STS2026/
