...
#SBATCH --output=/work/tesi_averonese/nnLandmark/logs/MML03_%j.out
#SBATCH --error=/work/tesi_averonese/nnLandmark/logs/MML03_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python /homes/averonese/nnLandmark/nnlandmark/dataset_conversion/nnLandmark/Dataset733_MML/03_images.py \
    --base /work/grana_maxillo/averonese_STS2026/mmld_dataset \
    --target /work/grana_maxillo/averonese_STS2026/nnLM/nnLM_raw/Dataset733_MML/imagesTs
