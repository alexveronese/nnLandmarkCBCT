...
#SBATCH --output=/work/tesi_averonese/nnLandmark/logs/MML01_%j.out
#SBATCH --error=/work/tesi_averonese/nnLandmark/logs/MML01_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python /homes/averonese/nnLandmark/nnlandmark/dataset_conversion/nnLandmark/Dataset733_MML/01_data_analysis.py \
